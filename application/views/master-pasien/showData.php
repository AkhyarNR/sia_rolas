        ...
        <div class="col-md-12">
          <div class="box">
              <div class="box-header">
                <h3 class="box-title">
                  <a href="<?php echo base_url();?>MasterPasien/add" role="button" class="btn btn-success btn-fill pull-left" ><i class='fa fa-plus'></i> &nbsp;TAMBAH DATA</a>
                </h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <table id="example2" class="display responsive nowrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><a title="Resep" href="<?php echo base_url().'MasterPasien/resep/'.$value['id'];?>"><?php echo $value['nik'] ?></a></td>
                        <td><?php if($value['no_bpjs']!=NULL) echo $value['no_bpjs']; ?></td>
                        ...
                        <td>
                          ...
                          <button class="btn btn-danger btn-sm btn-fill" data-href="<?php echo base_url().'MasterPasien/delete/'.$value['id'];?>" data-toggle='modal' data-target='#confirm-delete' title="Hapus">
