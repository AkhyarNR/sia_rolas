<section class="content">
    <!-- form start -->
    <form action="<?php echo base_url()?>TransaksiJual/insert" method="post" enctype="multipart/form-data" novalidate> <div class="box box-default">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tgljual" value="<?php echo date("Y-m-d")?>" placeholder="Tanggal Penjualan" required>
                    </div> 
