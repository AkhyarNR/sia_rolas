...
--
-- Host: localhost
-- Waktu pembuatan: 12 Jul 2020 pada 14.47
...
--
-- Dumping data untuk tabel `m_apotek`
--
...
(1, 'REG.01.011', 'AMINOPHYLLIN  INJ', 18200, 12500, 1),
(2, 'REG.01.019', 'ANTRAIN', 0, 24000, 1),
(3, 'REG.02.070', 'AQUA BIDEST', 0, 3500, 1),
(4, 'REG.01.444', 'BENODON INJ', 0, 18000, 1),
(5, 'REG.01.087', 'CYANOCOBALAMIN', 12, 5500, 1),
...
--
-- Struktur dari tabel `t_detail_obat`
--
...
--
-- Dumping data untuk tabel `t_detail_obat`
--

INSERT INTO `t_detail_obat` (`id`, `id_obat`, `id_supplier`, `batch`, `tgl_pembelian`, `exp_date`, `harga_beli`, `qty`, `status`) VALUES
(10, 1, 1, 'G129100', '2020-06-21', '2023-06-22', 12000, 1200, 1),
(11, 5, 5, 'G1291012', '2020-06-21', '2023-06-25', 12000, 12, 1),
(18, 1, 1, 'G129102', '2020-06-30', '2020-06-27', 12000, 5000, 1),
(19, 1, 1, '7626221', '2020-06-30', '2020-06-30', 10000, 12000, 1);

--
-- Trigger `t_detail_obat`
--
DELIMITER $$
...
(16, 4, 1, 1, 'G129102', '2023-06-12', 124, 1234, 153016),
(19, 5, 1, 1, 'G129102', '2020-06-27', 5000, 12000, 60000000),
(20, 5, 1, 1, '7626221', '2020-06-30', 12000, 10000, 120000000);
...
INSERT INTO `t_detail_penjualan` (`id`, `id_penjualan`, `id_obat`, `qty`, `harga`, `sub_total`) VALUES
(1, 1, 1, 221, 123, 27183),
(2, 1, 1, 123, 123, 15129);
...
--
-- Struktur dari tabel `t_detail_retur`
--
...
(21, 'TXB0000002', '2020-06-21', 1, 0, 'G129100', 'B', 1200, 0, 2400, 2),
(22, 'TXB0000003', '2020-06-21', 1, 0, 'G129100', 'B', 1200, 0, 3600, 2),
(23, 'TXB0000003', '2020-06-21', 4, 0, 'G129101', 'B', 1000, 0, 2000, 2),
(27, 'TXB0000001', '2020-06-21', 1, 0, 'G129100', 'B', 1200, 0, 1200, 2),
(28, 'TXB0000001', '2020-06-21', 5, 0, 'G1291012', 'B', 12, 0, 12, 2),
(32, 'TXB0000004', '2020-06-29', 1, 0, 'G129102', 'B', 124, 0, 1324, 2),
(35, 'TXB0000005', '2020-06-30', 1, 0, 'G129102', 'B', 5000, 0, 6200, 2),
(36, 'TXB0000005', '2020-06-30', 1, 0, '7626221', 'B', 12000, 0, 18200, 2);
...
(4, 'TXB0000004', '2020-06-29', 124, 153016, 'img_TXB0000004.png', 2),
(5, 'TXB0000005', '2020-06-30', 17000, 180000000, '', 2);
...
--
-- Indeks untuk tabel `t_detail_obat`
--
...
--
-- Indeks untuk tabel `t_detail_retur`
--
...
--
-- AUTO_INCREMENT untuk tabel `m_apotek`
--
ALTER TABLE `m_apotek`
...
--
-- AUTO_INCREMENT untuk tabel `t_detail_obat`
--
ALTER TABLE `t_detail_obat`
...
--
-- AUTO_INCREMENT untuk tabel `t_detail_retur`
--
ALTER TABLE `t_detail_retur`
