...
--
-- Host: localhost
-- Waktu pembuatan: 13 Jul 2020 pada 17.45
...
(10, 1, 1, 'G129100', '2020-06-21', '2023-06-22', 12000, 0, 1),
(11, 5, 5, 'G1291012', '2020-06-21', '2023-06-25', 12000, 12, 1),
(18, 1, 1, 'G129102', '2020-06-30', '2020-06-27', 12000, 4990, 1),
...
(1, 'REG.01.011', 'AMINOPHYLLIN  INJ', 16990, 12500, 1),
(2, 'REG.01.019', 'ANTRAIN', 0, 0, 1),
(3, 'REG.02.070', 'AQUA BIDEST', 0, 0, 1),
...
INSERT INTO m_detail_obat VALUES (NULL,NEW.id_obat, NEW.id_supplier, NEW.batch, (SELECT tgl_pembelian FROM t_pembelian WHERE id=NEW.id_pembelian), NEW.exp_date, NEW.harga, 0, NEW.qty, 1);
INSERT INTO t_mutasi VALUES (NULL,(SELECT no_transaksi FROM t_pembelian WHERE id = NEW.id_pembelian), (SELECT tgl_pembelian FROM t_pembelian WHERE id = NEW.id_pembelian), NEW.id_obat, NEW.batch, 'B', NEW.qty, '', (SELECT total_qty FROM m_obat WHERE id=NEW.id_obat), (SELECT id_user FROM t_pembelian WHERE id=NEW.id_pembelian));
END
$$
DELIMITER ;
...
(21, 7, 10, 2, 12500, 150000),
(22, 7, 18, 10, 12500, 150000);
...
INSERT INTO `t_detail_retur_masuk` (`id`, `id_pembelian_obat`, `id_obat`, `id_supplier`, `batch`, `exp_date`, `qty`, `harga`, `sub_total`) VALUES
(11, 1, 1, 1, 'G129100', '2023-06-22', 1200, 1200, 0),
(12, 1, 5, 5, 'G1291012', '2023-06-25', 12, 12000, 0),
(16, 4, 1, 1, 'G129102', '2023-06-12', 124, 1234, 0),
(19, 5, 1, 1, 'G129102', '2020-06-27', 5000, 12000, 0),
(20, 5, 1, 1, '7626221', '2020-06-30', 12000, 10000, 0);
...
(7, 'TXJ0000007', '2020-07-13', NULL, 0, 0, 2);
